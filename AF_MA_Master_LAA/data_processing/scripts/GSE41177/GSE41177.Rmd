...
allfiles <- list.files("C:/Users/sergi/OneDrive/Documents/PhD Heidelberg/Projects/AF_MA_Master_LAA/data_processing/scripts/GSE41177/data")
CELfiles <- paste("C:/Users/sergi/OneDrive/Documents/PhD Heidelberg/Projects/AF_MA_Master_LAA/data_processing/scripts/GSE41177/data/",sort(allfiles[grep(".CEL",allfiles)]),sep="")
...
GSE41177_targets <- targets %>% mutate(condition = case_when(
  condition > 23 ~ "AF",
  condition < 24 ~ "SR"))

save(GSE41177_targets, file = "./GSE41177_targets.ro")
```
...
GSE41177_counts = AF_expr_mat
        
save(GSE41177_counts, file = "./GSE41177_counts.ro")
```
