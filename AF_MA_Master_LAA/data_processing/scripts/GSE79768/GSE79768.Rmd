...
allfiles <- list.files("C:/Users/sergi/OneDrive/Documents/PhD Heidelberg/Projects/AF_MA_Master_LAA/data_processing/scripts/GSE79768/data")
CELfiles <- paste("C:/Users/sergi/OneDrive/Documents/PhD Heidelberg/Projects/AF_MA_Master_LAA/data_processing/scripts/GSE79768/data/",sort(allfiles[grep(".CEL",allfiles)]),sep="")
...
targets$condition = str_sub(targets$sample, start = 9, end = 10)
GSE79768_targets <- targets %>% mutate(condition = case_when(
  condition > 97 | condition < 10 ~ "SR",
  condition < 97 | condition > 10 ~ "AF"))

save(GSE79768_targets, file = "./GSE79768_targets.ro")
```
...
GSE79768_counts = AF_expr_mat
        
save(GSE79768_counts, file = "./GSE79768_counts.ro")
```
