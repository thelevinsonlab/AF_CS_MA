...
allfiles <- list.files("C:/Users/sergi/OneDrive/Documents/PhD Heidelberg/Projects/AF_MA_Master_LAA/data_processing/scripts/GSE14975/data")
CELfiles <- paste("C:/Users/sergi/OneDrive/Documents/PhD Heidelberg/Projects/AF_MA_Master_LAA/data_processing/scripts/GSE14975/data/",sort(allfiles[grep(".CEL",allfiles)]),sep="")
...
GSE14975_targets <- targets %>% mutate(condition = case_when(
  condition > 60 ~ "SR",
  condition < 61 ~ "AF"))

save(GSE14975_targets, file = "./GSE14975_targets.ro")
```
...
GSE14975_counts = AF_expr_mat
        
save(GSE14975_counts, file = "./GSE14975_counts.ro")
```
