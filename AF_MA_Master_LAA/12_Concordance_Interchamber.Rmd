...
```{r}
LAA_DE_genes <- read_excel("./AF_MA_Master_LAA/SupplementalTable2.xlsx")
RAA_DE_genes <- read_excel("./AF_MA_Master_RAA/SupplementalTable2.xlsx")
```
...
pdf("data/figures/sup/SupplementalFigure13.pdf", width = 14, height = 10)
