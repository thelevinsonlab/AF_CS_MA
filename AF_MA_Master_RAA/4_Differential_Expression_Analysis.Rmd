...
pval = ggplot(deg_stats$pvalue,
  ...
  labs(
    title = "P-value distribution per experiment - RAA", # add title
...
tval = ggplot(deg_stats$tvalue,
  ...
  geom_boxplot(width=0.2, fill="white") + # add boxplot
  labs(
    title = "T-value distribution per experiment - RAA", # add title
    x = "Experiment", # label x-axis
...
lfc = ggplot(deg_stats$lfc,
  ...
  geom_boxplot(width=0.2, fill="white") + # add boxplot
  labs(
    title = "Log Fold Change distribution per experiment - RAA", # add title
    x = "Experiment", # label x-axis
...
grid.text(paste0("B"), x = 0.01, y = 0.993, 
