...
max_class = InPerformance_zoom_df[order(InPerformance_zoom_df$meanAUC, decreasing = TRUE), ][1, ]
...
```{r}
pdf("data/figures/sup/SupplementalFigurePerformance.pdf",
    width = 10,
    height = 4.5)
